...
`),e=e.replace(/(<p>.*?<\/p>)/gs,u=>u.replace(/\n/g,"<br>")),t.forEach(({id:u,content:h})=>{e=e.split(u).join(h)}),i.forEach(({id:u,content:h})=>{e=e.replace(u,h)}),n.forEach(({id:u,content:h})=>{const d=h.replace(/```(\w+)?\n?/g,"").replace(/```/g,"");e=e.replace(u,`<pre><code>${Bc(d)}</code></pre>`)}),e}function Bc(s){const e=document.createElement("div");return e.textContent=s,e.innerHTML}function is(s){if(!s||!s.description)return"";const e=(s.type||"HTML").toLowerCase();return e==="md"||e==="markdown"?Xy(s.description):s.description}let jy,qy,Ye;const Dt=document.getElementById("projectSlider"),Nt=document.getElementById("blogSlider"),Uu=document.getElementById("publicationSlider"),U=document.getElementById("projectDisplay"),z=document.getElementById("blogDisplay"),j=document.getElementById("publicationDisplay"),ur=document.getElementById("scrollToTop"),zi=document.getElementById("commandPalette"),Hi=document.getElementById("commandInput"),Yt=document.getElementById("commandResults");document.getElementById("projectControls");document.getElementById("blogControls");document.getElementById("publicationControls");const Sr=document.getElementById("projectSearch"),Mr=document.getElementById("blogSearch"),Er=document.getElementById("publicationSearch"),En=document.getElementById("projectFilters"),Tn=document.getElementById("blogFilters"),wn=document.getElementById("publicationFilters");new In(document.querySelector("canvas.webgl"));const An=document.querySelector(".main-box");function Ou(){let s=!1;if(U&&U.classList.contains("active")){s=!0;const e=U.getBoundingClientRect();U.style.setProperty("--fade-out-width",`${e.width}px`),U.style.setProperty("--fade-out-height",`${e.height}px`),U.style.setProperty("--fade-out-max-width",`${e.width}px`),U.style.setProperty("--fade-out-min-height",`${e.height}px`),U.classList.add("fade-out-down"),U.classList.remove("active"),setTimeout(()=>{U.classList.remove("fade-out-down"),U.style.visibility="hidden",U.style.removeProperty("--fade-out-width"),U.style.removeProperty("--fade-out-height"),U.style.removeProperty("--fade-out-max-width"),U.style.removeProperty("--fade-out-min-height")},400)}if(z&&z.classList.contains("active")){s=!0;const e=z.getBoundingClientRect();z.style.setProperty("--fade-out-width",`${e.width}px`),z.style.setProperty("--fade-out-height",`${e.height}px`),z.style.setProperty("--fade-out-max-width",`${e.width}px`),z.style.setProperty("--fade-out-min-height",`${e.height}px`),z.classList.add("fade-out-down"),z.classList.remove("active"),setTimeout(()=>{z.classList.remove("fade-out-down"),z.style.visibility="hidden",z.style.removeProperty("--fade-out-width"),z.style.removeProperty("--fade-out-height"),z.style.removeProperty("--fade-out-max-width"),z.style.removeProperty("--fade-out-min-height")},400)}if(j&&j.classList.contains("active")){s=!0;const e=j.getBoundingClientRect();j.style.setProperty("--fade-out-width",`${e.width}px`),j.style.setProperty("--fade-out-height",`${e.height}px`),j.style.setProperty("--fade-out-max-width",`${e.width}px`),j.style.setProperty("--fade-out-min-height",`${e.height}px`),j.classList.add("fade-out-down"),j.classList.remove("active"),setTimeout(()=>{j.classList.remove("fade-out-down"),j.style.visibility="hidden",j.style.removeProperty("--fade-out-width"),j.style.removeProperty("--fade-out-height"),j.style.removeProperty("--fade-out-max-width"),j.style.removeProperty("--fade-out-min-height")},400)}s?setTimeout(()=>{document.body.classList.remove("project-focused","blog-focused","publication-focused"),window.innerWidth<=1800&&Cn()},400):(document.body.classList.remove("project-focused","blog-focused","publication-focused"),window.innerWidth<=1800&&Cn()),setTimeout(()=>{if(U&&U.querySelector(".project-display-title")){const e=U.querySelector(".project-display-title");e.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",e.style.borderImageSlice="1"}if(z&&z.querySelector(".project-display-title")){const e=z.querySelector(".project-display-title");e.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",e.style.borderImageSlice="1"}},200),Ye&&Ye.announce("Returned to about page","polite")}An&&An.addEventListener("click",s=>{if(!s.target.closest(".minimize-btn")){if(An.classList.contains("minimized")&&!document.body.classList.contains("project-focused")&&!document.body.classList.contains("blog-focused")&&!document.body.classList.contains("publication-focused")){s.preventDefault(),zu();return}document.body.classList.contains("project-focused")||document.body.classList.contains("blog-focused")||document.body.classList.contains("publication-focused")?(s.preventDefault(),Ou()):Rs()}});window.displayProjectsSlider=Rs;window.displayBlogsSlider=Ur;window.displayPublicationsSlider=Or;window.revertToFrontPage=Ou;function $y(){if(!Dt)return;const s=document.getElementById("projectsContainer");s&&(s.innerHTML="",Kt.forEach((e,t)=>{const n=document.createElement("div");n.className="project-item",n.id=e.id||`project-${t}`,n.setAttribute("data-id",e.id||`project-${t}`),n.setAttribute("data-project",t),n.setAttribute("data-category","project"),n.setAttribute("role","listitem"),n.setAttribute("tabindex","0"),n.setAttribute("aria-label",`Project: ${e.title}`),n.innerHTML=`
    ...
    `;const r=U.querySelector(".permalink-btn");r&&r.addEventListener("click",l=>{l.stopPropagation(),navigator.clipboard.writeText(window.location.href).catch(c=>console.error("Failed to copy URL",c))}),e.gradient&&(U.style.borderImageSource=e.gradient,U.style.borderImageRadius="10px",U.style.borderImageSlice="1");const o=U.querySelector(".project-display-title");o&&(o.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",o.style.borderImageSlice="1"),i.forEach(l=>{l.classList.contains("active")&&(l.classList.remove("active"),l.style.borderImageSource="")});const a=i[s];if(a){const l=a.getAttribute("data-gradient");l&&(a.style.borderImageSource=l,a.style.borderImageSlice="1"),requestAnimationFrame(()=>{a.classList.add("active")})}U.classList.remove("fade-out-down"),U.classList.add("fade-in-up"),window.innerWidth>1024&&(U.style.display="block",U.style.visibility="hidden",U.style.opacity="0",ws(!0)),U.style.visibility="visible",U.style.opacity="",requestAnimationFrame(()=>{U.classList.add("active"),window.innerWidth>1024&&setTimeout(()=>{ws(!1)},50),window.innerWidth<=1800&&setTimeout(()=>{Cn()},100),setTimeout(()=>{U.classList.remove("fade-in-up")},400)}),window.innerWidth<=1024&&U.scrollIntoView({behavior:"smooth",block:"nearest"}),window.MathJax&&MathJax.typesetPromise([U]).catch(l=>console.log(l.message)),Ye&&Ye.announce(`Project ${e.title} details displayed`,"polite")}function dr(s){const e=Zt[s];if(!e||!z)return;document.body.classList.remove("project-focused","publication-focused"),document.body.classList.add("blog-focused"),pi(),mi(),$n();const t=document.querySelector(".main-box");t&&t.classList.contains("minimized")&&t.classList.remove("minimized"),document.querySelectorAll(".nav-link").forEach(l=>{l.getAttribute("href")==="#blogs"&&l.classList.remove("active")});const i=document.querySelectorAll("#blogsContainer .project-item");z.innerHTML=`
        ...
        <div class="project-display-tags">${e.tags}</div>
        <div class="project-display-date">${e.date}</div>
    `;const r=z.querySelector(".permalink-btn");r&&r.addEventListener("click",l=>{l.stopPropagation(),navigator.clipboard.writeText(window.location.href).catch(c=>console.error("Failed to copy URL",c))}),e.gradient&&(z.style.borderImageSource=e.gradient,z.style.borderImageRadius="10px",z.style.borderImageSlice="1");const o=z.querySelector(".project-display-title");o&&(o.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",o.style.borderImageSlice="1"),i.forEach(l=>{l.classList.contains("active")&&(l.classList.remove("active"),l.style.borderImageSource="")});const a=i[s];if(a){const l=a.getAttribute("data-gradient");l&&(a.style.borderImageSource=l,a.style.borderImageSlice="1"),requestAnimationFrame(()=>{a.classList.add("active")})}z.classList.remove("fade-out-down"),z.classList.add("fade-in-up"),window.innerWidth>1024&&(z.style.display="block",z.style.visibility="hidden",z.style.opacity="0",As(!0)),z.style.visibility="visible",z.style.opacity="",document.body.classList.add("blog-focused"),requestAnimationFrame(()=>{z.classList.add("active"),window.innerWidth>1024&&setTimeout(()=>{As(!1)},50),window.innerWidth<=1800&&setTimeout(()=>{Cn()},100),setTimeout(()=>{z.classList.remove("fade-in-up")},400)}),window.innerWidth<=1024&&z.scrollIntoView({behavior:"smooth",block:"nearest"}),window.MathJax&&MathJax.typesetPromise([z]).catch(l=>console.log(l.message)),Ye&&Ye.announce(`Blog ${e.title} details displayed`,"polite")}function Ar(s){const e=Jt[s];if(!e)return;pi(),mi();const t=document.querySelectorAll("#publicationsContainer .project-item"),n=t[s];if(!(!n||!j)){if(n.classList.contains("active")?history.pushState(null,null," "):history.pushState(null,null,`#${e.id||""}`),n.classList.contains("active")){j.classList.contains("active")&&(j.classList.remove("active"),j.style.visibility="hidden"),n.classList.remove("active"),n.style.borderImageSource="",document.body.classList.remove("publication-focused"),setTimeout(()=>{if(j.querySelector(".project-display-title")){const i=j.querySelector(".project-display-title");i.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",i.style.borderImageSlice="1"}},200),Ye&&Ye.announce("Publication details closed","polite");return}if(U&&U.classList.contains("active")){const i=U.getBoundingClientRect();U.style.width=`${i.width}px`,U.style.height=`${i.height}px`,U.style.minHeight=`${i.height}px`,U.style.maxWidth=`${i.width}px`,U.classList.add("fade-out-down"),U.classList.remove("active"),document.querySelectorAll("#projectsContainer .project-item.active").forEach(o=>{o.classList.remove("active"),o.style.borderImageSource=""}),setTimeout(()=>{U.classList.remove("fade-out-down"),U.style.visibility="hidden",U.style.removeProperty("width"),U.style.removeProperty("height"),U.style.removeProperty("min-height"),U.style.removeProperty("max-width"),document.body.classList.remove("project-focused"),Po(s)},400);return}if(z&&z.classList.contains("active")){const i=z.getBoundingClientRect();z.style.width=`${i.width}px`,z.style.height=`${i.height}px`,z.style.minHeight=`${i.height}px`,z.style.maxWidth=`${i.width}px`,z.classList.add("fade-out-down"),z.classList.remove("active"),document.querySelectorAll("#blogsContainer .project-item.active").forEach(o=>{o.classList.remove("active"),o.style.borderImageSource=""}),setTimeout(()=>{z.classList.remove("fade-out-down"),z.style.visibility="hidden",z.style.removeProperty("width"),z.style.removeProperty("height"),z.style.removeProperty("min-height"),z.style.removeProperty("max-width"),document.body.classList.remove("blog-focused"),Po(s)},400);return}if(j.classList.contains("active")){const i=Jt[s],r=Array.from(t).find(c=>c.classList.contains("active"));r&&(r.classList.remove("active"),r.style.borderImageSource="");const o=j.getBoundingClientRect(),a=o.width,l=o.height;j.style.width=`${a}px`,j.style.height=`${l}px`,j.style.minHeight=`${l}px`,j.style.maxWidth=`${a}px`,j.classList.add("fade-out-down"),j.classList.remove("active"),setTimeout(()=>{j.style.removeProperty("width"),j.style.removeProperty("height"),j.style.removeProperty("min-height"),j.style.removeProperty("max-width"),j.innerHTML=`
                <div class="project-display-title">${i.title}</div>
                <div class="project-display-description">${is(i)}</div>
                <div class="project-display-tags">${i.tags}</div>
                <div class="project-display-date">${i.date}</div>
            `,i.gradient&&(j.style.borderImageSource=i.gradient,j.style.borderImageRadius="10px",j.style.borderImageSlice="1");const c=j.querySelector(".project-display-title");c&&(c.style.borderImage="radial-gradient(#b0b0b0, #d0d0d0)",c.style.borderImageSlice="1"),j.classList.remove("fade-out-down"),j.classList.add("fade-in-up"),window.innerWidth>1024&&(j.style.display="block",j.style.visibility="hidden",j.style.opacity="0",Ts(!0)),j.style.visibility="visible",j.style.opacity="",requestAnimationFrame(()=>{j.classList.add("active"),window.innerWidth>1024&&setTimeout(()=>{Ts(!1)},50),window.innerWidth<=1800&&setTimeout(()=>{Cn()},100)});const u=t[s];if(u){const h=u.getAttribute("data-gradient");h&&(u.style.borderImageSource=h,u.style.borderImageSlice="1"),u.classList.add("active")}window.MathJax&&MathJax.typesetPromise([j]).catch(h=>console.log(h.message)),setTimeout(()=>{j.classList.remove("fade-in-up")},400)},400)}else Po(s)}}function Po(s){const e=Jt[s];if(!e||!j)return;document.body.classList.remove("project-focused","blog-focused"),document.body.classList.add("publication-focused"),pi(),mi(),$n();const t=document.querySelector(".main-box");t&&t.classList.contains("minimized")&&t.classList.remove("minimized"),document.querySelectorAll(".nav-link").forEach(l=>{l.getAttribute("href")==="#publications"&&l.classList.remove("active")});const i=document.querySelectorAll("#publicationsContainer .project-item");j.innerHTML=`
        <button class="permalink-btn" aria-label="Copy link to ${e.title}" title="Copy direct link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path>
                <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path>
