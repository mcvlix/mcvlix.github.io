...
import giniVertexShaders from '../../shaders/gini/vertex.glsl'
import giniFragmentShaders from '../../shaders/gini/fragment.glsl'
...
export default class Gini
{
    ...
    setMaterial()
    {
        ...
        this.material = new THREE.ShaderMaterial({
            vertexShader: giniVertexShaders,
            fragmentShader: giniFragmentShaders,
            uniforms:{
                uTime: {value: 0},
                // animSpeed: {value: 10},
                // 
